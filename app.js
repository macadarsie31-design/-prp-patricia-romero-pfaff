...
async function generateAiBestVersion() {
  ...
  try {
    ...
    let friendly = "No pudimos generar la simulación en este momento. Probá nuevamente en unos minutos.";
    if (/daily|neuron|quota|limit|exceed|3040|capacity/i.test(raw)) {
      friendly = "La simulación avanzada alcanzó temporalmente su capacidad gratuita de hoy. Podés intentarlo nuevamente más tarde.";
    }
    alert(friendly);
  } finally {
