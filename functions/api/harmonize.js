...
//
// v6: klein-4b handles texture/color corrections well (surco, ojeras — v5
// worked) but under-delivers on structural/geometric ones (V-shape jawline
// taper, lip size) because "keep bone structure" in v5 was written broadly
// enough to also suppress those. Added V-shape jaw taper and bigger lips as
// explicit top-priority items (same blunt imperative style that worked for
// v5), and narrowed the "preserve" language so it protects identity without
// blocking a slimmer jaw contour or larger lips.
function buildPrompt() {
  return [
    "Apply these specific visible corrections to this face: 1) Fill and soften the nasolabial folds (the creases running from the nose to the corners of the mouth) so they are much less visible. 2) Fully correct the dark circles and hollow tear-trough shadow under the eyes — brighten and even out that area so it blends smoothly into the cheek, no dark shadow left. 3) Make the lips NOTICEABLY BIGGER and fuller than the original — a clear, visible increase in lip volume, not just hydration — while keeping the same lip shape, Cupid's bow and natural lip color. 4) Lift and add volume to the cheeks/cheekbones (malar area) for a more contoured, lifted midface. 5) Slim and taper the lower jaw and jaw angle to create a clearly visible, elegant V-shaped facial contour — narrower at the jawline than the original.",
    "Also apply, where it benefits this face: relaxed and smoother forehead and glabella lines; a fresh, rested eye area with a subtle elegant lateral brow/canthal lift (foxy-eye effect); a very subtle lift and refinement of the nasal tip, keeping the person's recognizable nose; reduced jowls; healthier, more even skin with visible real pores and texture — no makeup added, no blush, no lipstick, no beauty filter.",
    "All of this must be a photorealistic edit of the EXACT SAME PERSON, sharp and highly detailed, not blurry, not textured with fake wrinkles or grain/noise anywhere on the skin. Keep the person's core identity clearly recognizable — same eye color, ethnicity, hairline, hair color, hairstyle, ears, skin tone, head position, facial expression, camera angle, perspective, background, lighting and clothing exactly as in the original photo — while still applying the visible jawline taper and lip volume increase requested above.",
    "The corrections above should be clearly visible in a before-and-after comparison — a confident, well-defined harmonization result with real structural change, not just a skin/texture touch-up — while still looking anatomically plausible and unmistakably like the same person.",
    "Do not: swap identity, change eye color, create an unnatural or surgical-looking canthal change, create duck lips (overly rounded/protruding), freeze the expression, create a tiny generic 'Barbie' nose, add plastic or waxy skin, add fake grain/texture/wrinkles anywhere on the skin, apply any makeup (no blush, no bronzer, no lipstick, no eyeshadow, no foundation), change hair color or hairstyle, change the background, change the lighting, or change the camera angle."
  ].join(" ");
}
