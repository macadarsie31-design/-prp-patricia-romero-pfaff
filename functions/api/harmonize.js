...
function buildPrompt() {
  return [
    "Photorealistic edit of the EXACT SAME PERSON in the uploaded photo. Do not change identity: keep the same face shape, bone structure, eye color, eye shape and spacing, nose, mouth, lip shape, ethnicity, hairline, hair color, hairstyle, ears, skin tone, head position, facial expression, camera angle, perspective, background, lighting and clothing exactly as in the original photo.",
    "Simulate a natural, high-end, non-surgical full-face aesthetic harmonization performed by an expert injector, applied only where it benefits this specific face: relaxed and smoother forehead and glabella lines, fresher and subtly lifted eye area with reduced tear-trough shadows and less tiredness, restored midface and cheekbone volume and definition, softened nasolabial and marionette folds, naturally hydrated and refined lips with the same lip shape and Cupid's bow, cleaner jawline with reduced jowls and a subtle elegant lower-face contour, a harmonized chin, and healthier, more even skin — visible real pores and skin texture, no makeup added, no beauty filter.",
    "The result should be a moderate, clearly visible but realistic improvement — not extreme, not overdone. This must look like a real unedited photograph of the SAME person after treatment, never a different person or a generic AI beauty face.",
    "Do not: swap identity, change bone structure, change eye color or spacing, create duck lips or overfilled cheeks, freeze the expression, create an extreme V-line or pointed chin, add plastic or waxy skin, change hair color or hairstyle, change the background, change the lighting, or change the camera angle."
  ].join(" ");
}
